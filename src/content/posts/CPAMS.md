...
description: 一种低成本接入多模型 API 的思路：用 CPAMS / CLIProxyAPI 将 OAuth 模型通道封装成 OpenAI 兼容接口，让本地 AI 工具更自由地调用 Gemini、Claude、GPT/Codex 等模型能力。
image: ../assets/blogimg/cliproxyapi.png
tags:
  - Claude
  - Gemini
  - Antigravity
...
![capms项目](../assets/blogimg/capms项目.webp)

选取适合版本的二进制程序包下到本地解压
解压后得到以下文件
![capms解压](../assets/blogimg/capms解压.webp)
...
![capms前端资源](../assets/blogimg/capms前端资源.webp)
...
```
会跳出终端界面，如下：
![capms-cmd](../assets/blogimg/capms-cmd.webp)
无视即可。
访问管理页面：http://服务器IP:8317
![capms页面](../assets/blogimg/capms页面.webp)

### 5、更改配置
现在我们可以去配置面板页去更改配置了。
- (1)`网络配置`
![capms配置1](../assets/blogimg/capms-net.webp)
- (2)`设置自己的apikey`
![capms配置2](../assets/blogimg/capms-认证.webp)
- (3)`记得保存`
![capms配置3](../assets/blogimg/capms-保存.webp)
...
![gemini projest](../assets/blogimg/gemin-projest.webp)
